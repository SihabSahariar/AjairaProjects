...
int main()
     ...
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
     printf("\n\t\t   Takai Takaaaaaaaaaaaaa!!!!!!!!!!!    ") ;
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
     printf("\n\t\t > Press S to start");
     printf("\n\t\t > Press V to view highest score  ");
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to Proshno-Uttor --------------------------",playername);
    ...
    printf("\n    total of 10 questions. Each right answer will be awarded BDT 100,000!");
...
game:
     ...
     switch(r)
		...
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;getch();}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C.Hadudu");getch();
		       goto score;
		       break;}
		...
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is D.Dhaka");getch();
		       goto score;
		       break;}
        ...
        case 10:
		printf("\n\n\nWhich is the longest Sea Beach in the world?");
		printf("\n\nA.Cox's Bazar\t\tB.Koshi\n\nC.Ganga\t\tD.Amazon");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch(); break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Cox's Bazar");getch();break;goto score;}
	...
	{
	   printf("\n\n\t\t**************** CONGRATULATION *****************");
	     printf("\n\t You won BDT %.2f",score);goto go;}

	 else if(score==1000000.00)
	{
	    printf("\n\n\n \t\t**************** CONGRATULATION ****************");
	    printf("\n\t\t\t\t YOU HAVE TAKAI TAKAAAAAAAAAAAAAAAAAAAAA!!!!!!!!!");
	    printf("\n\t\t You won BDT %.2f",score);
	    printf("\t\t Thank You!!");
	}
	 else
{
...
void help()
    ...
    printf("\n    total 10 questions each right answer will be awarded BDT 100,000.");
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****Proshno-Uttor is developed by Sihab Sahariar********");}
